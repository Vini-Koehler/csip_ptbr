...
# Create a scoring key
csip.key <- list("CSIPPA"=c(14,22,30,38,46,54,62,70),
                 "CSIPBC"=c(15,23,31,39,47,55,63,71),
                 "CSIPDE"=c(16,24,32,40,48,56,64,72),
                 "CSIPFG"=c(17,25,33,41,49,57,65,73),
                 "CSIPHI"=c(18,26,34,42,50,58,66,74),
                 "CSIPJK"=c(19,27,35,43,51,59,67,75),
                 "CSIPLM"=c(20,28,36,44,52,60,68,76),
                 "CSIPNO"=c(21,29,37,45,53,61,69,77))
# Score from key
...
csip.cent <- t(apply(csip[,15:78], 1, function(x) x - mean(x)))
